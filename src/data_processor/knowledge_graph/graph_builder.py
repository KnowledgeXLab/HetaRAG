...
from src.data_processor.knowledge_graph.leanrag.build_LeanRAG_graph import (
    leanrag_graph_builder,
)
...
def graph_builder(data_path, working_dir, method="hirag"):
    ...
    elif method.lower() == "leanrag":
        leanrag_graph_builder(data_path, working_dir)
    else:
