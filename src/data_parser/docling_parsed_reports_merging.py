...
class PageTextPreparation:
    ...
    def __init__(
        ...
        self.serialized_tables_instead_of_markdown = (
            serialized_tables_instead_of_markdown
        )
        ...
        for t in self.report_data.get("tables", []):
            if t.get("table_id") == table_id:
                if self.use_serialized_tables:
                    return self._get_serialized_table_text(
                        t, self.serialized_tables_instead_of_markdown
                    )
